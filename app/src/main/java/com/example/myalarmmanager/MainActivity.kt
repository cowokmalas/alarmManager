...
import com.example.myalarmmanager.broadcast.AlarmReceiver
import com.example.myalarmmanager.fragment.DatePickerFragment
import com.example.myalarmmanager.fragment.TimePickerFragment
...
class MainActivity : AppCompatActivity(), View.OnClickListener, DatePickerFragment.DialogDateListener, TimePickerFragment.DialogTimeListener {
    ...
    override fun onDialogTimeSet(tag: String?,hourOfDay:Int,minut:Int){
        val calendar=Calendar.getInstance()
